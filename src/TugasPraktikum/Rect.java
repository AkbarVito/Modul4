...
public class Rect {
    ...
    /* contruktor dengan panjang dan lebar dimulai dari koordinat 0,0 */
    public Rect(int width, int height){
        this(0,0, width, height);
    }
    /** contruktor persegi no1. */
    public Rect(){
        this(0,0,0,0);
    }
    ...
    /** method untuk memerikasa apa satu titik dalam persegi panjang*/
